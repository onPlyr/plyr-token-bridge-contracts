...
import "@wandevs/message/contracts/interfaces/IWmbGateway.sol";
import "@wandevs/message/contracts/interfaces/IWmbReceiver.sol";
 ...
 */
abstract contract WmbApp is OwnableUpgradeable, IWmbReceiver {
     ...
     */
    function __initialize(address _wmbGateway) virtual internal {
    ...
    function wmbReceive(
        ...
        require(trustedRemotes[fromChainId][from] || from == address(this), "WmbApp: Remote is not trusted");
